...
#
# Required:
#   GCC 3.4 or later (the SCO native 2.95.3 may also work — tar 1.34
#       doesn't need C99-specific features). Set CC and put it on PATH,
#       or override via the GCC env var below.
